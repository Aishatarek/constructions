    ...
    <>
        ...
        <Container fluid>
          <Row className='align-items-center'>
            <Col md="6" sm="12" className='text-center'>
              <img className="slideInLeft wow" data-wow-duration="0.5s"  src="images/Picture5.png" alt="" />
            </Col>
            <Col md="6" sm="12" className="grouptext">
              <div className="slideInRight wow" data-wow-duration="0.5s"  src="images/Picture5.png">
      ...
      <section className='groupsec bg' id="Diar">
        <Container fluid>
          <Row className='align-items-center'>
            ...
            <Col md="6" sm="12" className='text-center'>
              <img className="slideInRight wow" data-wow-duration="0.5s"  src="images/Picture3.png" alt="" />
            </Col>
          </Row>
        </Container>
      </section>
      <section className='groupsec ' id="flash">
        <Container fluid>
          <Row className='align-items-center'>
            <Col md="6" sm="12" className='text-center'>
              <img src="images/Picture6.png" className="slideInLeft wow" data-wow-duration="0.5s"  alt="" />
            </Col>
            <Col md="6" sm="12" className="grouptext">
      ...
      <section className='groupsec bg' id="pixels">
        <Container fluid>
          <Row className='align-items-center'>
            ...
            <Col md="6" sm="12" className='text-center'>
              <img className="slideInRight wow" data-wow-duration="0.5s"  src="images/Picture4.png" alt="" />
            </Col>
          </Row>
        </Container>
      </section >
