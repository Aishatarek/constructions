    ...
    return (
        <>
            <section className="homeSec1">
                <div className="wow fadeInUp span12" data-wow-duration="1s" >
            ...
            <section className="homesec2">
                <Container>
                    <h2 className="wow fadeIn" data-wow-duration="1s" >Our Group</h2>
                    <Row>
                        <Col lg="3" md="3" sm="12" >
                            <div >
                        ...
                        <Col lg="3" md="3" sm="12" >
                            <div >
                                <div className="hoverdiv wow fadeInRight" data-wow-duration="1s" >
            ...
            <section className="homesec8">
                <Container>
                    <Row className="align-items-center">
                        <Col md="6" lg="6" sm="12" className="wow slideInLeft span12" data-wow-duration="0.5s" >
                        ...
                        <Col md="6" lg="6" sm="12" className="wow fadeInUp span12" data-wow-duration="0.5s" >
                            <Swiper
                                slidesPerView={1}
                                spaceBetween={30}
                                slidesPerGroup={1}
            ...
            <section className="homesec4">
                <Container>
                    <Row>
                        <Col lg="3" md="3" sm="12" className="wow slideInLeft span12" data-wow-duration="1s" >
                        ...
                        <Col lg="9" md="9" sm="12">
                            <Row>
                                <Col md="3" sm="12">
                                    <div className="servicediv wow bounceIn span12" data-wow-duration="1s" data-wow-delay="0.1s">
                                ...
                                <Col md="3" sm="12">
                                    <div className="servicediv wow bounceIn span12" data-wow-duration="1s" data-wow-delay="0.2s">
                                        <div className="serviceicon">
                                ...
                                <Col md="3" sm="12">
                                    <div className="servicediv wow bounceIn span12" data-wow-duration="1s" data-wow-delay="0.3s">
                                        <div className="serviceicon">
                                ...
                                <Col md="3" sm="12">
                                    <div className="servicediv wow bounceIn span12" data-wow-duration="1s"  data-wow-delay="0.4s">
                                        <div className="serviceicon">
                                ...
                                <Col md="3" sm="12">
                                    <div className="servicediv wow bounceIn span12" data-wow-duration="1s" data-wow-delay="0.5s">
                                        <div className="serviceicon">
                                ...
                                <Col md="3" sm="12">
                                    <div className="servicediv wow bounceIn span12" data-wow-duration="1s" data-wow-delay="0.6s">
                                        <div className="serviceicon">
                                ...
                                <Col md="3" sm="12">
                                    <div className="servicediv wow bounceIn span12" data-wow-duration="1s" data-wow-delay="0.7s">
                                        <div className="serviceicon">
                                ...
                                <Col md="3" sm="12">
                                    <div className="servicediv wow bounceIn span12" data-wow-duration="1s" data-wow-delay="0.8s">
                                        <div className="serviceicon">
                    ...
                    <Row>
                        <Col lg="6" md="6" sm="12">
                            ...
                            <Swiper
                                ...
                                className="mySwiper wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.5s"
                            >
            ...
            {/* <section className="homesec7">
                <Container className="wow fadeInUp span12" data-wow-duration="1s" >
                    <h5>PREMIUM SERVICES</h5>
                    <h3>We provide the <span> best services</span></h3>
                </Container>
                <Container fluid>
                    <Row>
                        <Col lg="3" md="3" sm="12" className="wow bounceInLeft span12" data-wow-duration="1s" >
                        ...
                        <Col lg="3" md="3" sm="12" className="wow bounceInDown span12" data-wow-duration="1s" >
                            <div className="logosdiv">
                                <img src="images/Picture5.png" alt="" />
                                <ul className="swiperp">
                                    <li>
                        ...
                        <Col lg="3" md="3" sm="12" className="wow bounceInUp span12" data-wow-duration="1s" >
                            <div className="logosdiv">
                                <img src="images/Picture4.png" alt="" />
                                <ul className="swiperp">
                                    <li>
                        ...
                        <Col lg="3" md="3" sm="12" className="wow bounceInRight span12" data-wow-duration="1s" >
                            <div className="logosdiv">
                                <img src="images/Picture6.png" alt="" />
                                <ul className="swiperp">
                                    <li>
