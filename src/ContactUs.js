          ...
          <Row>
            <Col md="6" sm="12">
              <div className="slideInLeft wow" data-wow-duration="0.5s">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3455.3097136204456!2d31.140479500000005!3d29.999262099999996!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14584571d58ca7c7%3A0xaf7988634f30dd56!2sMonglnls!5e0!3m2!1sen!2seg!4v1662122042746!5m2!1sen!2seg"
                  width="600"
                  height="450"
                  allowFullScreen
                  loading="lazy"
                ...
                <div>
                  <div className="mt-5">
                    ...
                    <p>
                        ...
                        Flash water: Hurghada - Airport Street - in front of
                        Al-Nahda School
                        <br />
                        <br />
      ...
      <section className="contactsec3">
        ...
        <div className="info">
          ...
          <div className="d-flex my-1">
            <GoLocation />
            <p>
              جمال الدين البنا، كفر نصار، الهرم
              <br /> Al Haram, Giza Governorate
            </p>
          </div>
          <div className="d-flex my-1">
            <BsTelephone />
