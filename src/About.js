  ...
  return (
    <>
          ...
          <Row>
            <Col lg="6" md="6" sm="12">
              ...
              >
                <h3>Our Company</h3>
                <p>
                  We are a young group of individuals from different
                  professional background each with a passion to be part of
                  something bigger than themselves. So we brought everything we
                  know together, to build on one another and create a single
                  entity that provides a premium service to other businesses.
                </p>
              </div>
            </Col>
            <Col lg="6" md="6" sm="12">
      ...
      <section className="aboutsec3">
        <Container>
          <h3
            className="fadeInDown wow span12"
            data-wow-duration="0.5s"
              ...
              >
                ...
                <div>
                  ...
                  <p>
                    ...
                    more simple and regular than that.
                  </p>
                </div>
              </div>
            </Col>
          ...
          <Row>
            ...
            <Col lg="6" md="6" sm="12">
              ...
              >
                <h3>Our Mission</h3>
                <p>
                  Providing the best services in the projects of infrastructure
                  to achieve the customer satisfaction through high quality
                  implementation fast accomplishment with high quality
                  specifications and standards and competitive prices.
                </p>
                <h3>Our Values</h3>
                <ul>
                  <li>Work Hard</li>
