  ...
  return (
    <>
      <section className='projectssec1'>
        <div className="fadeInUp wow" data-wow-duration="1s">
          <h3>Our Projects</h3>
        </div>
      </section>
      <section className='projectssec2'>
        <h3 className="fadeInDown wow" data-wow-duration="1s">Our Swimming pools and Land scape Projects</h3>
        <Container>
          <Row>
            {projects.slice(0, 7).map((project) => {
              return (
                <Col md="4" sm="12" key={project.id} onClick={() => handleShowee(project.id)}>
                  <div className="projectdiv bounceIn wow" data-wow-duration="1s" data-wow-delay="o.1s">
        ...
        <Container>
          <Row>
            ...
            <Col md="6" sm="12" className='text-center'>
              <img className='detailimg slideInRight wow' data-wow-duration="1s" src="images/SLO-pqxohas18by3uuetq4j91wu9t9hveajwagtiatomee.jpg" alt='' />
            </Col>
            {projects.slice(7, 16).map((project) => {
              return (
                <Col md="4" sm="12" key={project.id} onClick={() => handleShowee(project.id)}>
                  <div className="projectdiv bounceInUp wow span3" data-wow-duration="1s">
